...
builder.Services.AddScoped<IProgramDataRepository, ProgramDataRepository>();
...
builder.Services.AddDbContext<ApplicationDBContext>(options => options.UseCosmos(connectionString, dbName));
